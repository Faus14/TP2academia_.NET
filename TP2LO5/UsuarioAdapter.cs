...
namespace Data.Database
{
    public class UsuarioAdapter:Adapter
    {
         ...
         * metodo para el login
         public Business.Entities.Usuario Login(int ID, String pass)
        {
            Usuario usr = new Usuario();
            try
            {
                this.OpenConnection();   
                SqlCommand cmdUsuarios = new SqlCommand("select * from usuarios where id_usuario=@id and clave=@pass", sqlConn);
                cmdUsuarios.Parameters.Add("@id", SqlDbType.Int).Value = ID;
